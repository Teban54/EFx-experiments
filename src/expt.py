...
def generate_utilities(N, M):
    ...
    Utilities are totally random except they obey the following two rules:
    1) Ui(S) > 0 for all S that is a subset of all goods.
    2) If S1 is a subset of S2, then Ui(S1) <= Ui(S2).
